...
PinoySeoul provides a complete RESTful API for managing short links. Full API documentation is available via OpenAPI.
...
Visit your PinoySeoul instance at `https://your-domain/_docs/scalar` for interactive API documentation.
...
Authorization: Bearer PinoySeoulCool
Content-Type: application/json

{
  "url": "https://github.com/pinoyseoul/linkshortener",
  "slug": "PinoySeoul",
  "comment": "GitHub repo",
  "expiration": "2025-12-31T23:59:59Z",
  "ios": "https://apps.apple.com/app/id6745417598",
  "android": "https://play.google.com/store/apps/details?id=com.example",
  "ogTitle": "PinoySeoul - Link Shortener",
